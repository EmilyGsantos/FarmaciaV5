...
<head>
    ...
    <div>
    <br><button class="bnt-index"><a class="a-index" href="../index.php">Voltar</a></button><br>
    </div>
</head>
<body>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $farmacia_popular = isset($_POST['farmacia_popular']) ? $_POST['farmacia_popular'] : null;
    ...
    if ($stmt->affected_rows > 0) {
        ...
        header("Location: ../DAO/processa_cadastro.php");
    } else {
        echo "Erro ao cadastrar cliente. Erro do MySQL: " . $stmt->error . "<br>";
    }
